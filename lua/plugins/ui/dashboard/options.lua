...
[[    `9XXXXXXXXXXXP' `9XX'   NOT0DAY    `98v8P' N0MONEY  `XXP' `9XXXXXXXXXXXP']],
[[        ~~~~~~~       9X.          .db|db.          .XP       ~~~~~~~]],
...
local buttons = {
  ...
  val = {
    ...
    dashboard.button("d", "  Directory Marks", "\\m<C-b><CR>"),
    dashboard.button("s", "  Load session", "\\t"),
    dashboard.button("n", "  New file", ":ene <BAR> startinsert <CR>"),
    dashboard.button("c", "  Configuration", ":e ~/.config/nvim/init.lua <CR>"),
    dashboard.button("e", "e  Menu", ":Neotree reveal current<CR>"),
    dashboard.button("<Tab>", "  Lazy plugins" , ":Lazy<CR>"),
    dashboard.button("b", "B  Show keybindings", ":e ~/shared/shared-configs/shared-dotfiles/.config/neovim-config/keybindings.md<CR>"),
